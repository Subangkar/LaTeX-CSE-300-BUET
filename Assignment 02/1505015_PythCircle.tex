...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=0.45]
        ...
        % theta
        \draw [blue,line width=.75pt] (2.25,0) to [out=90,in=125] (1.95,0.6888136781);
        \node [above] at (2.85,-0.15) {$\theta$};
        % \pic [draw=blue, "$\theta$", angle eccentricity=1.5] {angle = (2.25,0)--(1.95,0.7888136781)};
        
        % sin
        \draw [circle,<->=latex,line width=1.5pt] (6.45,0) -- (6.45,2.25);
        \node [right] at (6.5,1.125) {sin$\theta$};
        
        % cos
        \draw [circle,<->=latex,line width=1.5pt] (0,3.25) -- (5.56215,3.25);
