\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=0.5]
        ...
        \draw [sq_c] (.6,0) -- (.6,.5) -- (1,.5); % right angle

        \path [fill=sq_a] (0,-3.5) -- (0,-5.5) --(2,-5.5) -- (2,-3.5) -- (0,-3.5); %a2 fill
        \path [fill=sq_b] (3,-3) -- (3,-6.25) -- (6.5,-6.25) -- (6.5,-3) --(3,-3); % b2 fill
        \path [fill=sq_c] (-6,-6.5) -- (-6,-2.5) -- (-1.5,-2.5) -- (-1.5,-6.5) -- (-6,-6.5) ; %c2 fill
